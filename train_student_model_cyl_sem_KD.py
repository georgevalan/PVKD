...
def main(args):
    ...
    while epoch < train_hypers['max_num_epochs']:
        # Run gc before each epoch to clean unwanted variables
        import gc
        gc.collect()
...
def evaluate_model(best_val_miou, loss_func, lovasz_softmax, model_save_path, my_model, pytorch_device, unique_label,
                   unique_label_str, val_dataset_loader):
    my_model.eval()
    hist_list = []
    val_loss_list = []
    with torch.no_grad():
