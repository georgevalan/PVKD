...
class cylinder_fea_student(nn.Module):

    def __init__(self, grid_size, fea_dim=3,
                 out_pt_fea_dim=64, max_pt_per_encode=64, fea_compre=None):
        super(cylinder_fea_student, self).__init__()

        # Remove the last layer of fully connected network used for extracting point features
