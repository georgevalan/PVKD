...
from network.segmentator_3d_asymm_spconv_student import Asymm_3d_spconv_student
from network.cylinder_fea_generator import cylinder_fea
from network.cylinder_fea_generator_student import cylinder_fea_student
...
def build(model_config):
    ...
    cylinder_3d_spconv_seg_student = Asymm_3d_spconv_student(
    ...
    cy_fea_net_student = cylinder_fea_student(grid_size=output_shape,
                              fea_dim=fea_dim,
                              out_pt_fea_dim=out_fea_dim,
                              fea_compre=num_input_features)

    model = get_model_class(model_config["model_architecture"])(
        cylin_model=cy_fea_net_student,
        segmentator_spconv=cylinder_3d_spconv_seg_student,
